...
export const METHOD_DOCS: Record<string, string> = {
  ...
  board_status: "Move a board item across statuses with the structured return contract on review.",
  task_file: "File a board item with goal, criteria, scope, and budget.",
  wake_subscribe: "Register a standing wake interest: a handle woken on scoped ready_for_review.",
  wake_unsubscribe: "Remove a standing wake interest by handle.",
