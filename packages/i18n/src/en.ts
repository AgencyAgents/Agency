...
export const en = {
  ...
  "onboarding.permissions_stored": "Starter permissions stored: reads run, writes and shell ask first.",
  ...
  "cli.error.invalid_permission_mode": '--permission-mode must be "ask", "allow-edits", or "deny".',
